namespace BeerPongAssociation.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BeerPongAssociation.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            ContextKey = "BeerPongAssociation.Models.ApplicationDbContext";
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                CreateUser(context, "admin@gmail.com", "123", "Pesho Admina");
